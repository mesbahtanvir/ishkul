/**
 * Tests for LessonSkeleton component
 */
...
describe('LessonSkeleton', () => {
  it('should render without crashing', () => {
    const { toJSON } = render(<LessonSkeleton />);
    expect(toJSON()).toBeTruthy();
  });

  it('should render screen header', () => {
    const { getByTestId } = render(<LessonSkeleton />);
    expect(getByTestId('screen-header')).toBeTruthy();
  });

  it('should render skeleton elements', () => {
    const { getAllByTestId } = render(<LessonSkeleton />);
  ...
  it('should call onBack when back button is pressed', () => {
    ...
    const { getByTestId } = render(<LessonSkeleton onBack={mockOnBack} />);
  ...
  it('should render without back button when onBack is not provided', () => {
    const { queryByTestId } = render(<LessonSkeleton />);
