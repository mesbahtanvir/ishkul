    ...
    sections: [
      {
        ...
        order: 0,
        lessons: [
          { id: 'lesson-1', title: 'Lesson 1', order: 0, estimatedMinutes: 30, status: 'pending', blocksStatus: 'pending' as ContentStatus },
          { id: 'lesson-2', title: 'Lesson 2', order: 1, estimatedMinutes: 30, status: 'pending', blocksStatus: 'pending' as ContentStatus },
        ],
      },
      {
        id: 'section-2',
        ...
        order: 1,
        lessons: [
          { id: 'lesson-3', title: 'Lesson 3', order: 0, estimatedMinutes: 30, status: 'pending', blocksStatus: 'pending' as ContentStatus },
        ],
      },
    ],
  },
          ...
          sections: [
            {
              ...
              order: 0,
              lessons: [
                { id: 'lesson-1', title: 'Only Lesson', order: 0, estimatedMinutes: 30, status: 'pending', blocksStatus: 'pending' as ContentStatus },
              ],
            },
          ],
        },
